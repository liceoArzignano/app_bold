...
interface IAnimationFactory {
    ...
    void fadeInView(View target, long duration, IAnimationFactory.AnimationStartListener listener);

    void fadeOutView(View target, long duration, IAnimationFactory.AnimationEndListener listener);
